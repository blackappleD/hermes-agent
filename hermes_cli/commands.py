...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("os_runtime", "Control passive/assisted OS Runtime continuation", "Session",
               aliases=("os-runtime",), args_hint="[status|passive|goal <text>|pause|resume|clear|tick]",
               subcommands=("status", "passive", "goal", "pause", "resume", "clear", "tick")),
