...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("os_runtime", "Control passive/assisted/autonomous OS Runtime", "Session",
               aliases=("os-runtime",), args_hint="[status|passive|goal <text>|pause|resume|clear|tick|autonomous]",
               subcommands=("status", "passive", "goal", "pause", "resume", "clear", "tick", "autonomous")),
    ...
    CommandDef("linz", "Manage native Linz World identity and world access", "Info",
               cli_only=True, args_hint="[status|login|logout|map|events|publish]",
               subcommands=("status", "login", "logout", "map", "events", "publish")),
