...
export const zh: Translations = {
  ...
  status: {
    ...
    platformError: "错误",
    recentSessions: "最近会话",
    restartGateway: "重启全部网关",
    restartingGateway: "正在重启全部网关…",
    running: "运行中",
  ...
  logs: {
    ...
    osRuntime: {
      ...
      showRaw: "展开原始日志",
      hideRaw: "收起原始日志",
      noData: "当前 profile 暂无 OS_RUNTIME 日志。",
      moduleNoData: "暂无数据",
      updated: "更新",
      source: "来源",
      parseErrors: "解析错误",
      ...
      modules: {
        life_state: "生命状态",
        tension_field: "张力场",
        action_potential: "行动势能",
        self_prompt: "自我提示",
        open_intent: "开放意图",
        arbitration: "裁判",
        runtime_driver: "运行时驱动",
      },
      fields: {
        energy: "能量",
        fatigue: "疲劳",
        ...
        curiosity: "好奇心",
        boredom: "无聊感",
        creative_pressure: "创作压力",
        social_hunger: "社交需求",
        silence_pressure: "沉默压力",
        restraint: "克制",
        life_cycle: "生命周期",
        recovery_cycle: "恢复周期",
        generated_intent_count: "生成意图数",
        active_tensions: "活跃张力",
        top_tension_id: "最高张力 ID",
        top_tension_type: "最高张力类型",
        intensity: "强度",
        activation: "激活度",
        trend: "趋势",
        trend_slope: "趋势斜率",
