...
def run_prepare(args: argparse.Namespace) -> int:
    ...
    output = {
        ...
        "next_action": "Run scripts/linz-world/formal_experiment_run.sh only after all checks pass." if success else "Fix failed checks before publishing formal events.",
    }
