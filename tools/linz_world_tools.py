...
registry.register(
    name="linz_compute",
    toolset="linz_world",
    schema={"description": "Invoke Linz World compute using the current login session.", "parameters": {"type": "object", "required": ["task"], "properties": {"task": {"type": "string"}, "input": {"type": "object"}}, "additionalProperties": False}},
