...
### `hermes linz import-skill-profile`

This command is explicitly out of scope for this feature.

**Outcome**

- Always returns a clear message that old linz-world-skill identity import is not supported in this version.
- Must not read or modify old linz-world-skill identity locations.
