...
11. Trigger compute without a successful Linz World login.
12. Expected: compute returns blocked/unsupported and no remote compute call is made.
13. Trigger compute after login with a fake login token secret reference.
